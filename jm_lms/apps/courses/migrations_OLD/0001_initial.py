    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_module', models.ForeignKey(related_name='modules_next', default=None, to='courses.Module', help_text='Next module link', null=True, verbose_name='Next module')),
                ('previous_module', models.ForeignKey(related_name='modules_last', default=None, to='courses.Module', help_text='Previous module link', null=True, verbose_name='Previous module')),
            ],
            options={
                'verbose_name': 'End of Module',
            },
        ),
        migrations.CreateModel(
